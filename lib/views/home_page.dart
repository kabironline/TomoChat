                      ...
                      builder: (BuildContext context, AsyncSnapshot snapshot) {
                        if (snapshot.hasData) {
                          return ListTile(
                            ...
                            title: Text(
                                snapshot.data[1] ?? messageStream.data.docs[index].data()['name'],
                            ...
                            trailing: Text(
                              messageStream.data.docs[index].data()['lastMessageTime'] != null
                                  ? convertTimeStamp(
                                      messageStream.data.docs[index].data()['lastMessageTime'])
                                  : "",
                              style: const TextStyle(color: Colors.white, fontSize: 14),
                            ),
                            onTap: () async {
                              ChannelProvider channelProvider = Provider.of<ChannelProvider>(
                                context,
                                listen: false,
                              );
